  ...
  return (
    <footer className="pt-12 border-t border-neutral-200 text-center space-y-4">
      <p className="text-[10px] text-neutral-500 leading-relaxed max-w-3xl mx-auto">
        ...
        The creation of this web app was facilitated by Google AI Studio and based on the <a href="https://github.com/otacke/h5p-theme-picker" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">H5P Theme Picker</a> by <a href="https://snordian.de/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Oliver Tacke</a> and its code is opened <a href="https://github.com/giofonseca/H5P-Theme-colours" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">here</a> to be audited by everyone.
      </p>
